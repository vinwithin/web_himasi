            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                  @foreach ($artikel as $item)
                    <article class="entry">
                        <div class="entry-img">
                            <img src="/storage/media/artikel/thumbnails/{{$item->image_artikel}}" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li class="d-flex align-items-center"><i class="bi bi-at"></i>{{$item->category_artikel->name}}</li>
                            </ul>
                        </div>
